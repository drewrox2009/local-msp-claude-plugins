...
describe("domains/assets.ts", () => {
  ...
  describe("getTools", () => {
    ...
    it("should define correct input schema for list tool", () => {
      const tools = assetsHandler.getTools();
      const listTool = tools.find((t) => t.name === "repairshopr_assets_list");
    ...
    it("should mark asset_id as required for get tool", () => {
      const tools = assetsHandler.getTools();
      const getTool = tools.find((t) => t.name === "repairshopr_assets_get");
    ...
    it("should have search tool with optional filters", () => {
      const tools = assetsHandler.getTools();
      const searchTool = tools.find((t) => t.name === "repairshopr_assets_search");
  ...
  describe("handleCall", () => {
    describe("repairshopr_assets_list", () => {
      it("should list assets with default parameters", async () => {
        ...
        const result = await assetsHandler.handleCall("repairshopr_assets_list", {});
      ...
      it("should list assets filtered by customer and type", async () => {
        ...
        await assetsHandler.handleCall("repairshopr_assets_list", {
          customer_id: 123,
          asset_type: "Server",
        });
    ...
    describe("repairshopr_assets_get", () => {
      it("should get an asset by ID", async () => {
        ...
        const result = await assetsHandler.handleCall("repairshopr_assets_get", {
          asset_id: 456,
        });
    ...
    describe("repairshopr_assets_search", () => {
      it("should search assets by query", async () => {
        ...
        const result = await assetsHandler.handleCall("repairshopr_assets_search", {
          query: "laptop",
        });
      ...
      it("should search by serial number", async () => {
        ...
        await assetsHandler.handleCall("repairshopr_assets_search", {

...
vi.mock("../../src/domains/customers.js", () => ({
  customersHandler: {
    getTools: vi.fn().mockReturnValue([{ name: "repairshopr_customers_list" }]),
    handleCall: vi.fn(),
  },
}));
...
vi.mock("../../src/domains/tickets.js", () => ({
  ticketsHandler: {
    getTools: vi.fn().mockReturnValue([{ name: "repairshopr_tickets_list" }]),
    handleCall: vi.fn(),
  },
}));
...
vi.mock("../../src/domains/assets.js", () => ({
  assetsHandler: {
    getTools: vi.fn().mockReturnValue([{ name: "repairshopr_assets_list" }]),
    handleCall: vi.fn(),
  },
}));
...
vi.mock("../../src/domains/contacts.js", () => ({
  contactsHandler: {
    getTools: vi.fn().mockReturnValue([{ name: "repairshopr_contacts_list" }]),
    handleCall: vi.fn(),
  },
}));
...
vi.mock("../../src/domains/invoices.js", () => ({
  invoicesHandler: {
    getTools: vi.fn().mockReturnValue([{ name: "repairshopr_invoices_list" }]),
    handleCall: vi.fn(),
  },
}));
...
describe("domains/index.ts", () => {
  ...
  describe("getDomainHandler", () => {
    ...
    it("should load the tickets handler", async () => {
      ...
      expect(tools).toContainEqual({ name: "repairshopr_tickets_list" });
    });
    ...
    it("should load the assets handler", async () => {
      ...
      expect(handler).toBeDefined();
      const tools = handler.getTools();
      expect(tools).toContainEqual({ name: "repairshopr_assets_list" });
    });
    ...
    it("should load the contacts handler", async () => {
      ...
      expect(handler).toBeDefined();
      const tools = handler.getTools();
      expect(tools).toContainEqual({ name: "repairshopr_contacts_list" });
    });
    ...
    it("should load the invoices handler", async () => {
      ...
      expect(handler).toBeDefined();
      const tools = handler.getTools();
      expect(tools).toContainEqual({ name: "repairshopr_invoices_list" });
    });

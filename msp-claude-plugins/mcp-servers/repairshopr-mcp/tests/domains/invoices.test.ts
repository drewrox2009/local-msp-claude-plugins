...
describe("domains/invoices.ts", () => {
  ...
  describe("getTools", () => {
    ...
    it("should define correct input schema for list tool", () => {
      const tools = invoicesHandler.getTools();
      const listTool = tools.find((t) => t.name === "repairshopr_invoices_list");
    ...
    it("should mark invoice_id as required for get tool", () => {
      const tools = invoicesHandler.getTools();
      const getTool = tools.find((t) => t.name === "repairshopr_invoices_get");
    ...
    it("should mark customer_id as required for create tool", () => {
      const tools = invoicesHandler.getTools();
      const createTool = tools.find((t) => t.name === "repairshopr_invoices_create");
    ...
    it("should mark invoice_id as required for email tool", () => {
      const tools = invoicesHandler.getTools();
      const emailTool = tools.find((t) => t.name === "repairshopr_invoices_email");
  ...
  describe("handleCall", () => {
    describe("repairshopr_invoices_list", () => {
      it("should list invoices with default parameters", async () => {
        ...
        const result = await invoicesHandler.handleCall("repairshopr_invoices_list", {});
      ...
      it("should list invoices filtered by customer and status", async () => {
        ...
        await invoicesHandler.handleCall("repairshopr_invoices_list", {
          customer_id: 123,
          status: "paid",
        });
    ...
    describe("repairshopr_invoices_get", () => {
      it("should get an invoice by ID", async () => {
        ...
        const result = await invoicesHandler.handleCall("repairshopr_invoices_get", {
          invoice_id: 456,
        });
    ...
    describe("repairshopr_invoices_create", () => {
      it("should create an invoice with required fields only", async () => {
        ...
        const result = await invoicesHandler.handleCall("repairshopr_invoices_create", {
          customer_id: 123,
        });
      ...
      it("should create an invoice with all fields", async () => {
        ...
        await invoicesHandler.handleCall("repairshopr_invoices_create", {
          customer_id: 100,
          date: "2024-03-01",
          due_date: "2024-03-31",
    ...
    describe("repairshopr_invoices_email", () => {
      ...
      it("should email an invoice with custom options", async () => {
        ...
        await invoicesHandler.handleCall("repairshopr_invoices_email", {
          invoice_id: 456,

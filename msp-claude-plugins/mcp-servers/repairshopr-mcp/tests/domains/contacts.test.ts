...
describe("domains/contacts.ts", () => {
  ...
  describe("getTools", () => {
    ...
    it("should define correct input schema for list tool", () => {
      const tools = contactsHandler.getTools();
      const listTool = tools.find((t) => t.name === "repairshopr_contacts_list");
    ...
    it("should mark contact_id as required for get tool", () => {
      const tools = contactsHandler.getTools();
      const getTool = tools.find((t) => t.name === "repairshopr_contacts_get");
    ...
    it("should mark customer_id and name as required for create tool", () => {
      const tools = contactsHandler.getTools();
      const createTool = tools.find((t) => t.name === "repairshopr_contacts_create");
  ...
  describe("handleCall", () => {
    describe("repairshopr_contacts_list", () => {
      it("should list contacts with default parameters", async () => {
        ...
        const result = await contactsHandler.handleCall("repairshopr_contacts_list", {});
      ...
      it("should list contacts filtered by customer", async () => {
        ...
        await contactsHandler.handleCall("repairshopr_contacts_list", {
          customer_id: 123,
        });
    ...
    describe("repairshopr_contacts_get", () => {
      it("should get a contact by ID", async () => {
        ...
        const result = await contactsHandler.handleCall("repairshopr_contacts_get", {
          contact_id: 456,
        });
    ...
    describe("repairshopr_contacts_create", () => {
      it("should create a contact with required fields only", async () => {
        ...
        const result = await contactsHandler.handleCall("repairshopr_contacts_create", {
          customer_id: 123,
          name: "New Contact",
        });
      ...
      it("should create a contact with all fields", async () => {
        ...
        await contactsHandler.handleCall("repairshopr_contacts_create", {
          customer_id: 100,
          name: "Full Contact",
          email: "full@test.com",
          phone: "555-1111",

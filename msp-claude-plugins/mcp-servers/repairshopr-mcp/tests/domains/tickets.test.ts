...
describe("domains/tickets.ts", () => {
  ...
  describe("getTools", () => {
    ...
    it("should define correct required fields for create tool", () => {
      const tools = ticketsHandler.getTools();
      const createTool = tools.find((t) => t.name === "repairshopr_tickets_create");
    ...
    it("should define correct required fields for add_comment tool", () => {
      const tools = ticketsHandler.getTools();
      const commentTool = tools.find((t) => t.name === "repairshopr_tickets_add_comment");
  ...
  describe("handleCall", () => {
    describe("repairshopr_tickets_list", () => {
      it("should list tickets with filters", async () => {
        ...
        const result = await ticketsHandler.handleCall("repairshopr_tickets_list", {
          customer_id: 123,
          status: "open",
          resolved: false,
        });
      ...
      it("should support since date filter", async () => {
        ...
        await ticketsHandler.handleCall("repairshopr_tickets_list", {
    ...
    describe("repairshopr_tickets_get", () => {
      it("should get a ticket by ID", async () => {
        ...
        const result = await ticketsHandler.handleCall("repairshopr_tickets_get", {
          ticket_id: 456,
        });
    ...
    describe("repairshopr_tickets_create", () => {
      it("should create a ticket with required fields", async () => {
        ...
        const result = await ticketsHandler.handleCall("repairshopr_tickets_create", {
          customer_id: 123,
          subject: "New Issue",
        });
      ...
      it("should create a ticket with all fields", async () => {
        ...
        await ticketsHandler.handleCall("repairshopr_tickets_create", {
          customer_id: 100,
          subject: "Full Ticket",
    ...
    describe("repairshopr_tickets_update", () => {
      it("should update a ticket", async () => {
        ...
        const result = await ticketsHandler.handleCall("repairshopr_tickets_update", {
          ticket_id: 123,
    ...
    describe("repairshopr_tickets_add_comment", () => {
      it("should add a comment to a ticket", async () => {
        ...
        const result = await ticketsHandler.handleCall("repairshopr_tickets_add_comment", {
          ticket_id: 123,
          body: "New comment",
        });
      ...
      it("should add a hidden comment without email", async () => {
        ...
        await ticketsHandler.handleCall("repairshopr_tickets_add_comment", {
          ticket_id: 123,
          body: "Internal note",
          subject: "Tech notes",
          hidden: true,

...
describe("domains/customers.ts", () => {
  ...
  describe("getTools", () => {
    ...
    it("should define correct input schema for list tool", () => {
      const tools = customersHandler.getTools();
      const listTool = tools.find((t) => t.name === "repairshopr_customers_list");
    ...
    it("should mark customer_id as required for get tool", () => {
      const tools = customersHandler.getTools();
      const getTool = tools.find((t) => t.name === "repairshopr_customers_get");
    ...
    it("should mark query as required for search tool", () => {
      const tools = customersHandler.getTools();
      const searchTool = tools.find((t) => t.name === "repairshopr_customers_search");
  ...
  describe("handleCall", () => {
    describe("repairshopr_customers_list", () => {
      it("should list customers with default parameters", async () => {
        ...
        const result = await customersHandler.handleCall("repairshopr_customers_list", {});
      ...
      it("should list customers with filters", async () => {
        ...
        await customersHandler.handleCall("repairshopr_customers_list", {
          query: "acme",
          email: "test@acme.com",
          page: 2,
          per_page: 50,
    ...
    describe("repairshopr_customers_get", () => {
      it("should get a customer by ID", async () => {
        ...
        const result = await customersHandler.handleCall("repairshopr_customers_get", {
          customer_id: 123,
        });
    ...
    describe("repairshopr_customers_create", () => {
      ...
      it("should create a customer with minimal fields", async () => {
        ...
        await customersHandler.handleCall("repairshopr_customers_create", {
    ...
    describe("repairshopr_customers_search", () => {
      it("should search customers with query", async () => {
        ...
        const result = await customersHandler.handleCall("repairshopr_customers_search", {
          query: "acme",
        });
      ...
      it("should search with custom limit", async () => {
        ...
        await customersHandler.handleCall("repairshopr_customers_search", {
          query: "test",
          limit: 100,
        });

...
describe("Error Handling", () => {
  ...
  describe("API Errors", () => {
    it("should propagate API errors from customers handler", async () => {
      ...
      await expect(
        customersHandler.handleCall("repairshopr_customers_list", {})
    ...
    it("should propagate API errors from tickets handler", async () => {
      ...
      await expect(
        ticketsHandler.handleCall("repairshopr_tickets_get", { ticket_id: 999999 })
    ...
    it("should propagate API errors from assets handler", async () => {
      ...
      await expect(
        assetsHandler.handleCall("repairshopr_assets_get", { asset_id: 999999 })
    ...
    it("should propagate API errors from contacts handler", async () => {
      ...
      await expect(
        contactsHandler.handleCall("repairshopr_contacts_create", { customer_id: 1, name: "" })
    ...
    it("should propagate API errors from invoices handler", async () => {
      ...
      await expect(
        invoicesHandler.handleCall("repairshopr_invoices_email", { invoice_id: 123 })
  ...
  describe("Network Errors", () => {
    it("should propagate network timeout errors", async () => {
      ...
      await expect(
        ticketsHandler.handleCall("repairshopr_tickets_list", {})
    ...
    it("should propagate connection refused errors", async () => {
      ...
      await expect(
        assetsHandler.handleCall("repairshopr_assets_list", {})

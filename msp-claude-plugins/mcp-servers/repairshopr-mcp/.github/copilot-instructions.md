...
> This file applies to all WYRE MCP servers (autotask-mcp, datto-rmm-mcp, repairshopr-mcp, halopsa-mcp, ninjaone-mcp, liongard-mcp, connectwise-manage-mcp, connectwise-automate-mcp, itglue-mcp, superops-mcp, atera-mcp, salesbuildr-mcp).

 ...
 *
 * Provides tools for contact operations in RepairShopr.
 */
...
function getTools(): Tool[] {
  return [
    {
      name: "repairshopr_contacts_list",
      description:
        "List contacts in RepairShopr. Can filter by customer ID or search query.",
      inputSchema: {
    ...
    {
      name: "repairshopr_contacts_create",
      description: "Create a new contact in RepairShopr",
      inputSchema: {
        type: "object" as const,
        properties: {
          customer_id: {
...
async function handleCall(
  ...
  switch (toolName) {
    case "repairshopr_contacts_list": {
    ...
    case "repairshopr_contacts_create": {

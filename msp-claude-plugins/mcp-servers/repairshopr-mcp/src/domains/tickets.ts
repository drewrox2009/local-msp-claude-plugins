 ...
 *
 * Provides tools for ticket operations in RepairShopr.
 */
...
function getTools(): Tool[] {
  return [
    {
      name: "repairshopr_tickets_list",
      description:
        "List tickets in RepairShopr. Can filter by customer, contact, status, user, problem type, or resolved state.",
      inputSchema: {
    ...
    {
      name: "repairshopr_tickets_create",
      description: "Create a new ticket in RepairShopr",
      inputSchema: {
        type: "object" as const,
        properties: {
          customer_id: {
    ...
    {
      name: "repairshopr_tickets_update",
      description: "Update an existing ticket in RepairShopr",
      inputSchema: {
        type: "object" as const,
        properties: {
          ticket_id: {
    ...
    {
      name: "repairshopr_tickets_add_comment",
...
async function handleCall(
  ...
  switch (toolName) {
    ...
    case "repairshopr_tickets_create": {
    ...
    case "repairshopr_tickets_update": {
      const ticketId = args.ticket_id as number;
    ...
    case "repairshopr_tickets_add_comment": {
      const ticketId = args.ticket_id as number;

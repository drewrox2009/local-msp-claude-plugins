 ...
 *
 * Provides tools for customer operations in RepairShopr.
 */
...
function getTools(): Tool[] {
  return [
    {
      name: "repairshopr_customers_list",
      description:
        "List customers in RepairShopr. Can filter by query, email, phone, or include disabled customers.",
      inputSchema: {
    ...
    {
      name: "repairshopr_customers_get",
    ...
    {
      name: "repairshopr_customers_create",
    ...
    {
      name: "repairshopr_customers_search",
      description:
...
async function handleCall(
  ...
  switch (toolName) {
    case "repairshopr_customers_list": {
    ...
    case "repairshopr_customers_get": {
    ...
    case "repairshopr_customers_create": {
    ...
    case "repairshopr_customers_search": {

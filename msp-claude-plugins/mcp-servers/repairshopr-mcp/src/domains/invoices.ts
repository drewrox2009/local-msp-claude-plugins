 ...
 *
 * Provides tools for invoice operations in RepairShopr.
 */
...
function getTools(): Tool[] {
  return [
    {
      name: "repairshopr_invoices_list",
      description:
        "List invoices in RepairShopr. Can filter by customer, status, or date range.",
      inputSchema: {
    ...
    {
      name: "repairshopr_invoices_create",
      description: "Create a new invoice in RepairShopr",
      inputSchema: {
        type: "object" as const,
        properties: {
          customer_id: {
    ...
    {
      name: "repairshopr_invoices_email",
...
async function handleCall(
  ...
  switch (toolName) {
    case "repairshopr_invoices_list": {
    ...
    case "repairshopr_invoices_create": {
    ...
    case "repairshopr_invoices_email": {
      const invoiceId = args.invoice_id as number;

 ...
 *
 * Provides tools for asset/configuration item operations in RepairShopr.
 */
...
function getTools(): Tool[] {
  return [
    {
      name: "repairshopr_assets_list",
      description:
        "List assets/configuration items in RepairShopr. Can filter by customer, asset type, or serial number.",
      inputSchema: {
    ...
    {
      name: "repairshopr_assets_search",
      description:
...
async function handleCall(
  ...
  switch (toolName) {
    ...
    case "repairshopr_assets_search": {

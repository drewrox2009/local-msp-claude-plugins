---
name: search-tickets
description: Search for tickets in RepairShopr by various criteria
arguments:
  - name: query
...
# Search RepairShopr Tickets

Search and filter tickets in RepairShopr using various criteria.

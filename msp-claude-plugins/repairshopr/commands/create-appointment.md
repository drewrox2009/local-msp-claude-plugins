...
description: Create a calendar appointment in RepairShopr
arguments:
  - name: subject
...
3. **Create the appointment**
   ```bash
   curl -s -X POST \
     "https://${REPAIRSHOPR_SUBDOMAIN}.repairshopr.com/api/v1/appointments?api_key=${REPAIRSHOPR_API_KEY}" \
...
URL: https://acme.repairshopr.com/appointments/11111
Calendar: https://acme.repairshopr.com/calendar
```
...
URL: https://acme.repairshopr.com/appointments/11112
Calendar: https://acme.repairshopr.com/calendar
```
...
URL: https://acme.repairshopr.com/appointments/11113
Calendar: https://acme.repairshopr.com/calendar
...
Use the RepairShopr web interface to find valid user IDs.
```
...
Contact your RepairShopr administrator if you need access.
```

### Rate Limiting

```
Rate limited by RepairShopr API (180 req/min)
...
For recurring work, create individual appointments or use RepairShopr's web interface for recurring patterns.

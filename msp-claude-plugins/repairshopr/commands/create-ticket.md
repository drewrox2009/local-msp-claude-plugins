---
name: create-ticket
description: Create a new service ticket in RepairShopr
arguments:
  - name: customer
...
# Create RepairShopr Ticket

Create a new service ticket in RepairShopr with specified details.
...
5. **Return ticket details**
   - Ticket number
   - Ticket ID
   - Direct URL to ticket in RepairShopr
...
| Error | Resolution |
|-------|------------|
| Invalid customer_id | Verify customer exists in RepairShopr |

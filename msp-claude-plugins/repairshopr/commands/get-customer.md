---
name: get-customer
description: Get detailed customer information from RepairShopr
arguments:
  - name: customer_id
...
- Customer must exist in RepairShopr
...
2. **Fetch customer details**
   ```bash
   curl -s -X GET \
     "https://${REPAIRSHOPR_SUBDOMAIN}.repairshopr.com/api/v1/customers/${customer_id}?api_key=${REPAIRSHOPR_API_KEY}"
   ```
...
URL: https://acme.repairshopr.com/customers/12345
```

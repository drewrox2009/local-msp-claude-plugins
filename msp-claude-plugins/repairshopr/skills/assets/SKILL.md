---
description: >
  Use this skill when working with RepairShopr assets - tracking hardware,
  ...
  management and endpoint monitoring through RepairShopr.
triggers:
  - repairshopr asset
  - repairshopr device
  - repairshopr computer
  - asset management repairshopr
  - rmm repairshopr
  - repairshopr inventory
  - repairshopr endpoint
  - patch management repairshopr
  - asset search repairshopr
  - repairshopr hardware
---

# RepairShopr Asset Management

## Overview

RepairShopr assets represent the hardware, software, and devices you manage for customers. Assets integrate with RepairShopr's built-in RMM capabilities for monitoring, patch management, and remote access. This skill covers asset tracking, RMM integration, and inventory management.
...
RepairShopr provides built-in remote access for managed assets:
...
- [RepairShopr Tickets](../tickets/SKILL.md) - Asset-related tickets
- [RepairShopr Invoices](../invoices/SKILL.md) - Asset billing

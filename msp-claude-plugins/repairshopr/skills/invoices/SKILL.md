---
description: >
  Use this skill when working with RepairShopr invoices - creating, managing,
  ...
  operations through RepairShopr.
triggers:
  - repairshopr invoice
  - repairshopr billing
  - repairshopr payment
  - invoice management repairshopr
  - line item repairshopr
  - repairshopr accounting
  - customer billing repairshopr
  - payment processing repairshopr
  - invoice search repairshopr
---

# RepairShopr Invoice Management

## Overview

RepairShopr invoices are the core of your billing workflow. Invoices can be created manually, generated from tickets, or produced automatically from recurring contracts. This skill covers invoice creation, line item management, payment processing, and billing workflows.
...
RepairShopr integrates with popular accounting software:
...
- [RepairShopr Customers](../customers/SKILL.md) - Customer billing info
- [RepairShopr Tickets](../tickets/SKILL.md) - Time tracking for billing

---
description: >
  Use this skill when working with RepairShopr customers - creating, updating,
  ...
  management and onboarding through RepairShopr.
triggers:
  - repairshopr customer
  - repairshopr client
  - repairshopr contact
  - customer management repairshopr
  - contact management repairshopr
  - client onboarding repairshopr
  - repairshopr site
  - repairshopr location
  - customer search repairshopr
---

# RepairShopr Customer Management

## Overview

RepairShopr customers are the foundation of your service delivery. Every ticket, asset, invoice, and contract is associated with a customer. This skill covers comprehensive customer management including CRUD operations, contact management, and site/location handling.
...
RepairShopr supports flexible customer categorization:
...
- [RepairShopr Tickets](../tickets/SKILL.md) - Service tickets for customers
- [RepairShopr Assets](../assets/SKILL.md) - Asset management
- [RepairShopr Invoices](../invoices/SKILL.md) - Customer billing

---
description: >
  Use this skill when working with RepairShopr tickets - creating, updating,
  ...
  Essential for MSP technicians handling service delivery through RepairShopr.
triggers:
  - repairshopr ticket
  - service ticket repairshopr
  - create ticket repairshopr
  - ticket status repairshopr
  - ticket priority
  - repairshopr service desk
  - ticket timer
  - resolve ticket repairshopr
  - ticket comments
  - time entry repairshopr
  - ticket search repairshopr
---

# RepairShopr Ticket Management

## Overview

RepairShopr tickets are the core unit of service delivery in the platform. Every client request, incident, and service task flows through the ticketing system. This skill covers comprehensive ticket management including creation, updates, timer operations, comments, and time tracking.

## Ticket Status Values

RepairShopr provides configurable ticket statuses. These are the common default values:
...
- [RepairShopr Customers](../customers/SKILL.md) - Customer and contact management
- [RepairShopr Assets](../assets/SKILL.md) - Asset tracking and RMM
- [RepairShopr Invoices](../invoices/SKILL.md) - Billing and payments
- [RepairShopr API Patterns](../api-patterns/SKILL.md) - Authentication and pagination
